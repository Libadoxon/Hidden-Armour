...
public class HiddenArmourClient implements ClientModInitializer {
    ...
    private static final KeyBinding.Category CATEGORY =
            KeyBinding.Category.create(Identifier.of("hiddenarmour", "hiddenarmour"));
    ...
    public void onInitializeClient() {
        ...
        toggleArmorKey =
                KeyBindingHelper.registerKeyBinding(
                        new KeyBinding("key.hiddenarmour.toggle", GLFW.GLFW_KEY_J, CATEGORY));

        // Open GUI with U
        openGuiKey =
                KeyBindingHelper.registerKeyBinding(
                        new KeyBinding("key.hiddenarmour.openGui", GLFW.GLFW_KEY_U, CATEGORY));
                ...
                client -> {
                    ...
                    while (toggleArmorKey.wasPressed()) {
                        ...
                        client.player.sendMessage(
                                Text.literal("Armour: ")
                                        .append(
                                                Text.literal(cfg.hideArmour ? "Hidden" : "Shown")
